...
console.log(solarSystem[7].moons[1]); // Output: Will print "Nereid" to the console; Keying into an Object using dot notation
console.log(solarSystem[7]["moons"][1]); // Output: Will print "Nereid" to the console; Keying into an Object using square bracket notation
 ...
 console.log(solarSystem[2]);
    ...
    const moonIndex = solarSystem[6].moons.indexOf("Umbriel");
    if (moonIndex !== -1) {
        solarSystem[6].moons[moonIndex] = "Oberon";
    }
